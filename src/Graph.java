...
public class Graph {
    ...
    public void printSortHeader(String listType, String sortType) {
        System.out.println("===================================");
        System.out.println(String.format("SORTED EDGES WITH %s USING %s",listType,sortType));
    }
...
//        }
    ...
    private void runListAlgorithms() {
        ...
        System.out.println(kruskal(quickSorted_listEdges));
